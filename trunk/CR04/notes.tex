...
% FIXME:
% - J'ai rajouté les figures manquantes du chapitre 1. Par contre, la différence d'épaisseur entre tes figures et les miennes viennent du latex ou de la figure elle-même?
% (j'ai fait tous mes traits avec l'épaisseur "normal")

% - La preuve complète au niveau de la sous-section "Reduction Stratégie" (il y a un Fixme à cet endroit)

% J'ai agencé les figures de manière qu'elles se trouvent près de leur texte correspondant si possible... Attention, c'est fragile... :oD
